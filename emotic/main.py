...
from custom_inference import custom_inference
...
def parse_args():
    ...
    # =====[ USEFUL ]=====
    parser.add_argument('--mode', type=str, default='train_test', choices=['train', 'test', 'train_test', 'inference', 'custom_inference'])
...
if __name__ == '__main__':
    ...
    # =====[ CUSTOM ]=====
    elif args.mode == 'custom_inference':
        if args.inference_file is None:
            raise ValueError('No inference file provided.')
        custom_inference(args.inference_file, model_path, result_path, context_norm, body_norm, ind2cat, ind2vad, args)
